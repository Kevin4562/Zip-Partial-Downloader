...
public class ZippedFile {
	...
	public String toString() {
		...
		sb.append("FILE LOCATION >> (" + this.byteLower + "," + this.byteUpper + ")" + System.getProperty("line.separator"));
		sb.append("COMPRESSED SIZE >> " + this.compressedSize + " (" + humanReadableByteCount(this.compressedSize, false) + ")" + System.getProperty("line.separator"));
		sb.append("UNCOMPRESSED SIZE >> " + this.uncompressedSize + " (" + humanReadableByteCount(this.uncompressedSize, false) + ")" + System.getProperty("line.separator"));
		...
		sb.append("FILE LAST MODIFICATION TIME >> " + this.fileLastModifiedTime + System.getProperty("line.separator"));
		sb.append("FILE LAST MODIFICATION DATE >> " + this.fileLastModifiedDate + System.getProperty("line.separator"));
	...
	public void process(byte[] bytes, int i) {
		try {
			...
			this.fileCRC = getFourByteInt(bytes, i, 16);
			...
			this.byteUpper = this.byteLower + this.compressedSize + (29 + this.fileNameLength + this.fileExtraFieldLength);
